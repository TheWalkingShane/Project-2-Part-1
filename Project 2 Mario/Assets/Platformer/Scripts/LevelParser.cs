    ...
    private void LoadLevel()
    {
        ...
        while (levelRows.Count > 0)
        {
            ...
            for (int column = 0; column < letters.Length; column++)
            {
                ...
                // DONE - Instantiate a new GameObject that matches the type specified by letter
                // DONE - Position the new GameObject at the appropriate location by using row and column
